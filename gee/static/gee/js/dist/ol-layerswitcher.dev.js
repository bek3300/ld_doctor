...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('ol/control/Control'), require('ol/Observable'), require('ol/layer/Group')) : typeof define === 'function' && define.amd ? define(['ol/control/Control', 'ol/Observable', 'ol/layer/Group'], factory) : global.LayerSwitcher = factory(global.ol.control.Control, global.ol.Observable, global.ol.layer.Group);
})(void 0, function (Control, ol_Observable, LayerGroup) {
  'use strict';
  ...
  var LayerSwitcher = function (_Control) {
    ...
    function LayerSwitcher(opt_options) {
      ...
      var options = Object.assign({}, opt_options); // TODO Next: Rename to showButtonTitle
      ...
      _this.startActive = options.startActive === true; // TODO Next: Rename to showButtonContent

      var label = options.label !== undefined ? options.label : ''; // TODO Next: Rename to hideButtonContent
    ...
    createClass(LayerSwitcher, [{
      ...
      value: function setMap(map) {
        var _this2 = this; // Clean up listeners associated with the previous map
      ...
      value: function renderPanel(map, panel, options) {
        ...
        var rendercomplete_event = new Event('rendercomplete'); // Dispatch the event.
      ...
      value: function setGroupVisibility(map) {
        ...
        groups.forEach(function (grp) {
          ...
          var descendantVisibility = grp.getLayersArray().map(function (l) {
            var state = l.getVisible(); // console.log('>', l.get('title'), state);
      ...
      value: function setChildVisibility(map) {
        ...
        groups.forEach(function (grp) {
          var group = grp; // console.log(group.get('title'));
